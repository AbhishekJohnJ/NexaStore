...
const sampleProducts = [
  ...
  {
    name: 'Protein Powder',
    description: 'Whey protein powder for muscle building - 2lb',
    category: 'Health',
    price: 34.99,
    stock: 80,
  ...
  },
  {
    ...
    description: 'Premium omega-3 fish oil supplements - 90 softgels',
    category: 'Health',
    price: 29.99,
    stock: 100,
  ...
  },
  {
    ...
    description: 'Antibacterial hand sanitizer - Pack of 6',
    category: 'Health',
    price: 18.99,
    stock: 200,
  ...
  },
  {
    ...
    description: 'Exercise resistance bands with different strengths',
    category: 'Health',
    price: 22.99,
    stock: 90,
  ...
  // Automotive Products
  {
    ...
    description: 'Universal smartphone car mount holder',
    category: 'Automotive',
    price: 19.99,
    stock: 110,
  ...
  },
  {
    ...
    description: 'Portable handheld car vacuum cleaner',
    category: 'Automotive',
    price: 39.99,
    stock: 70,
  ...
  },
  {
    ...
    description: 'Premium car air freshener - Pack of 10',
    category: 'Automotive',
    price: 14.99,
    stock: 150,
  ...
  },
  {
    ...
    description: 'Multi-pocket car seat back organizer',
    category: 'Automotive',
    price: 24.99,
    stock: 85,
  ...
  {
    name: 'Car Cover',
    description: 'Waterproof all-weather car cover',
    category: 'Automotive',
    price: 59.99,
    stock: 55,
  ...
  },
  {
    ...
    description: 'Super bright LED headlight bulbs - Pair',
    category: 'Automotive',
    price: 44.99,
    stock: 65,
  ...
  },
  {
    ...
    price: 24.99,
    stock: 100,
    image: 'https://images.unsplash.com/photo-1543857778-c4a1a3e0b2eb?w=400&h=400&fit=crop',
    rating: 4.5,
  },
  {
    name: 'Action Figure Collection',
    description: 'Superhero action figures - Set of 5',
    category: 'Toys',
    price: 39.99,
    stock: 75,
  ...
  {
    name: 'Drawing Tablet',
    description: 'LCD writing and drawing tablet for kids',
    category: 'Toys',
    price: 19.99,
    stock: 120,
  ...
  },
  {
    ...
    description: 'STEM learning kit with experiments',
    category: 'Toys',
    price: 44.99,
    stock: 70,
  ...
  {
    name: 'Drone for Kids',
    description: 'Easy-to-fly mini drone with camera',
    category: 'Toys',
    price: 79.99,
    stock: 50,
